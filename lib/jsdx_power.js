...
Power.prototype.listDevices = function(callback) {
	...
	self.manager.EnumerateDevices['finish'] = function(devices) {
		callback.apply(self, [ null, devices ]);
	};
	self.manager.EnumerateDevices['timeout'] = 10000;
	self.manager.EnumerateDevices();
};

Power.prototype.suspend = function() {
	var self = this;

	self.manager.Suspend();
};

Power.prototype.hibernate = function() {
	var self = this;
